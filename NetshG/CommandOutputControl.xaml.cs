    ...
    public partial class CommandOutputControl : UserControl, CanDoCommand
    {
        ...
        public async Task DoCommandAsyncRaw(CommandInfo ci, CommandOptions commandOptions, string overrideTitle)
        {
            ...
            try
            {
                ...
                {
                    result = await RunCommandLine.RunNetshGAsync(program, argsWithExtraMore, this as AddToText, commandHasOutput);
                }
                ...
                if (false && program == "netsh" && argsWithExtraMore.StartsWith("mbn show interfaces")) // Handy debugging 
                {
                    if (result.Length < 80)
                    {
